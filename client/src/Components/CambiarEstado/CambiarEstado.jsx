...
const CambiarEstado = () => {
    ...
    const [estadoEntregaError, setEstadoEntregaError] = useState('');
    ...
    const handleEstadoEntregaChange = (e) => {
        ...
        // Validate if the default option is selected
        if (selectedEstadoEntrega === '') {
            setEstadoEntregaError('Debe seleccionar un estado');
        } else {
            setEstadoEntregaError('');
        }
    
        // Reset dependent fields when changing state
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='actualizar-container'>
                            ...
                            <label className='tituloCam'>
                                ...
                                {estadoEntregaError && <div className="error">{estadoEntregaError}</div>}
                            </label>
                            ...
                            <button className='botoncito' type='submit'>Actualizar Estado</button>
                        </div>
                    </form>
                </div>
            ) : (
